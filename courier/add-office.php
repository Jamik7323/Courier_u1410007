...
// ]]> -->
 ...
 <div class="container" style="background-color: #fff; border-radius: 10px;">
 	<h2 align="center">Add New Office</h2>
  <form class="form-horizontal" action="process.php?action=add-office" method="post" name="frmShipment" > 
    <div class="form-group">
      <label class="control-label col-sm-2" for="name">Office Name:</label>
      <div class="col-sm-10">
        <input name="OfficeName" type="TEXT" id="OfficeName" size="40"  maxlength="100" class="form-control"  placeholder="Enter office" >
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input class="form-control" name="City" id="City" maxlength="13" size="40" type="TEXT" placeholder="Enter city">
      </div>
    </div>
    <!--  -->
    <div class="form-group">
    ...
    <!--  -->
    <div class="form-group">
      <label class="control-label col-sm-2" for="name">Office Time:</label>
      <div class="col-sm-10">
        <input name="OfficeTiming" id="OfficeTiming" maxlength="30" size="40" type="TEXT" class="form-control" placeholder="Enter Time">
      </div>
    </div>
    <!--  -->
    <div class="form-group">
    ...
    <div class="form-group "  style="text-align: right; padding-right: 15px;">
    	<input name="Submit" type="submit" onClick="MM_validateForm('OfficeName','','R','City','','R','PhoneNo','','R','OfficeTiming','','R','ContactPerson','','R','OfficeAddress','','R');return document.MM_returnValue" value="Add New Office " class="btn btn-info" >
    </div>
    </form>
 </div>
